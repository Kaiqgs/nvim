...
function M.get_vscode_js_debugger_path()
    local is_windows = M.is_os_windows()
    local path_unix = "/home/kags/3rdParty/vscode-js-debug"
    local debugger_path = is_windows and "C:/Users/Kaique/Documents/Scripts/vscode-js-debug" or path_unix
    return debugger_path
end

function M.get_local_lua_extension_path()
    local is_windows = M.is_os_windows()
    local path_unix = "/home/kags/local-lua-debugger-vscode/"
    return is_windows and "C:/..." or path_unix
end

function M.get_local_lua_debugger_path()
    local is_windows = M.is_os_windows()
    local path_unix = M.get_local_lua_extension_path() .. "extension/debugAdapter.js"
    return is_windows and "C:/..." or path_unix
end
